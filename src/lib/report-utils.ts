...
export function severityBadgeClass(sev: Severity): string {
  switch (sev) {
    case "CRITICAL":
      return "bg-sev-critical text-white border-sev-critical/60";
    case "HIGH":
      return "bg-sev-high/90 text-black border-sev-high/60";
    case "MEDIUM":
      return "bg-sev-medium/90 text-black border-sev-medium/60";
    case "LOW":
      return "bg-sev-low/80 text-black border-sev-low/60";
    case "INFO":
      return "bg-sev-info/60 text-white border-sev-info/60";
  }
}
